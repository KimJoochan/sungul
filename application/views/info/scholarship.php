    ...
    <section id="scholarship" class="page-section">
        <div class="inner" id="page-inner">
            ...
            <div class="scholar clearfix" style="border-bottom: 0;">
                ...
                <span class="btn" onclick="location.href='<?=base_url()?>esta/index/insertScholar?year=<?=$year?>'">등록하기</span><span class="btn" onclick="updateScholarCnt();">인원수 수정하기</span>
                <?php } ?></div>

            <div class="control clearfix">
                <div class="pull-left" onclick="location.href='<?=base_url()?>esta/index/scholarship?year=<?php echo (int)$year-1; ?>'"><?php echo (int)$year-1; ?></div>
                <div class="pull-right" onclick="location.href='<?=base_url()?>esta/index/scholarship?year=<?php echo (int)$year+1; ?>'"><?php echo (int)$year+1; ?></div>
